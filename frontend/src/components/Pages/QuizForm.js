		...
		<div className="pt-12 bg-gray-50">
			<div className="flex flex-col items-center text-center">
				...
				<div className="flex flex-col space-y-8 w-7/12 shadow-2xl h-auto my-12 p-5">
					{/* .......IMAGE UPLOADER.......... */}
					<div className="flex flex-row items-center justify-center w-full h-44 space-x-2 text-gray-600 bg-gray-100 cursor-pointer hover:bg-gray-200 rounded-lg transition duration-500 ease-in-out">
						<svg
